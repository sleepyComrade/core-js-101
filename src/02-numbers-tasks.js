 ...
 *   (0,1) (1,2)     => 0
 */
const getAngleBetweenVectors = (x1, y1, x2, y2) => Math.acos(((x1 * x2) + (y1 * y2))
 ...
 *     0     => 0
 */
const getLastDigit = (value) => `${value}`.slice(-1);
 ...
 */
const toNumber = (v, def) => (+v <= Number.MAX_VALUE && +v >= Number.MIN_VALUE ? +v : def);
